...
| <a name="input_peerings"></a> [peerings](#input\_peerings) | Hub to spoke peerings to deploy | <pre>list(object(<br>    {<br>      remote_vnet_name                = string<br>      remote_vnet_resource_group_name = string<br>    }<br>  ))</pre> | `[]` | no |
