...
| <a name="input_private_dns_zones"></a> [private\_dns\_zones](#input\_private\_dns\_zones) | Link virtual network to private dns zones | <pre>list(object(<br>    {<br>      resource_group_name = string<br>      name                = string<br>    }<br>  ))</pre> | `[]` | no |
