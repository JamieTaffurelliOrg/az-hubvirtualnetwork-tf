...
| <a name="input_private_dns_zone"></a> [private\_dns\_zone](#input\_private\_dns\_zone) | Link virtual network to private dns zone | <pre>object(<br>    {<br>      resource_group_name = string<br>      name                = string<br>      enable_link         = bool<br>    }<br>  )</pre> | <pre>{<br>  "enable_link": false,<br>  "name": "",<br>  "resource_group_name": ""<br>}</pre> | no |
